...
const travelIntakeMessage="機票／住宿請從「行程 → 我的行前資料」上傳，才能同步行程與報支。";
...
export default function ExpenseWizardLive({tripId}:{tripId:string}){
 ...
 return <main className="expense-workbench-page" id="my-expense">
  <header className="expense-workbench-head"><div><span>步驟 3・只顯示本人資料</span><h1>我的報支</h1><p>中間整理費用流水帳；右側集中上傳、文件、缺件與匯出。</p></div><button className="expense-drawer-trigger" onClick={()=>setShowDesktopTools(true)}>工具與文件</button></header>
  <>
